  ...
  <section class="flex items-center justify-between max-w-6xl h-24 border-b mb-20 relative">
    <div class="flex items-center h-full">
      <div class="h-full flex items-center">
        <img src="/images/logo.svg" alt="Sneakers logo" class="mr-6">
      </div>  
    ...
    <div class="flex items-center">
      ...
      <img src="/images/image-avatar.png" alt="Avatar image" class="w-10 h-10 rounded-full cursor-pointer hover:outline hover:outline-proj-22-orange-hover">
    </div>
