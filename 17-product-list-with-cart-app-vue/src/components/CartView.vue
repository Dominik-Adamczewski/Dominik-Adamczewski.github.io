<template>
  <div class="bg-white rounded-xl p-6 relative w-full">
    ...
    <div v-else>
      <CartProduct v-for="cartProduct in productsStore.cartProducts" :key="cartProduct.shortName" :productObj="cartProduct"/>
      ...
      <div class="flex items-center justify-center p-4 bg-proj-17-rose-100 rounded-xl">
        <img src="/images/icon-carbon-neutral.svg" alt="Carbon neutral icon" class="mr-1 mb-1">
        <span>This is a <span> carbon-neutral </span>delivery</span>
      </div>
