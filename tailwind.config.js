...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'proj-23-theme-1-light-grayish-orange-hover': 'hsl(30, 25%, 60%)',
        'proj-23-theme-1-light-grayish-orange-active': 'hsl(30, 25%, 84%)',
        'proj-23-theme-1-grayish-orange-hover': 'hsl(28, 16%, 70%)',
        'proj-23-theme-1-grayish-orange-active': 'hsl(28, 16%, 60%)',
        'proj-23-theme-1-desaturated-dark-blue-var-1-hover': 'hsl(225, 21%, 54%)',
        'proj-23-theme-1-desaturated-dark-blue-var-1-active': 'hsl(225, 21%, 44%)',
        'proj-23-theme-1-desaturated-dark-blue-var-2-hover': 'hsl(224, 28%, 40%)',
        'proj-23-theme-1-desaturated-dark-blue-var-2-active': 'hsl(224, 28%, 30%)',
        'proj-23-theme-1-red-hover': 'hsl(6, 63%, 55%)',
        'proj-23-theme-1-red-active': 'hsl(6, 63%, 45%)',
        'proj-23-theme-1-dark-red-hover': 'hsl(6, 70%, 39%)',
        'proj-23-theme-1-dark-red-active': 'hsl(6, 70%, 29%)',
        ...
        'proj-23-theme-2-light-grayish-yellow-hover': 'hsl(45, 7%, 94%)',
        'proj-23-theme-2-light-grayish-yellow-active': 'hsl(45, 7%, 84%)',
        'proj-23-theme-2-dark-grayish-orange-hover': 'hsl(35, 11%, 66%)',
        'proj-23-theme-2-dark-grayish-orange-active': 'hsl(35, 11%, 56%)',
        'proj-23-theme-2-dark-moderate-cyan-hover': 'hsl(185, 42%, 42%)',
        'proj-23-theme-2-dark-moderate-cyan-active': 'hsl(185, 42%, 32%)',
        'proj-23-theme-2-very-dark-cyan-hover': 'hsl(185, 58%, 30%)',
        'proj-23-theme-2-very-dark-cyan-active': 'hsl(185, 58%, 20%)',
        'proj-23-theme-2-orange-hover': 'hsl(25, 98%, 45%)',
        'proj-23-theme-2-orange-active': 'hsl(25, 98%, 35%)',
        'proj-23-theme-2-dark-orange-hover': 'hsl(25, 99%, 32%)',
        'proj-23-theme-2-dark-orange-active': 'hsl(25, 99%, 22%)',
        ...
        'proj-23-theme-3-very-dark-violet-var-3-hover': 'hsl(268, 47%, 26%)',
        'proj-23-theme-3-very-dark-violet-var-3-active': 'hsl(268, 47%, 16%)',
        'proj-23-theme-3-dark-magenta-hover': 'hsl(290, 70%, 41%)',
        'proj-23-theme-3-dark-magenta-active': 'hsl(290, 70%, 31%)',
        'proj-23-theme-3-dark-violet-hover': 'hsl(281, 89%, 31%)',
        'proj-23-theme-3-dark-violet-active': 'hsl(281, 89%, 21%)',
        'proj-23-theme-3-vivid-magenta-hover': 'hsl(285, 91%, 57%)',
        'proj-23-theme-3-vivid-magenta-active': 'hsl(285, 91%, 47%)',
        'proj-23-theme-3-pure-cyan-hover': 'hsl(176, 100%, 49%)',
  ...
  safelist: [
    ...
    "hover:br-proj-23-theme-1-light-grayish-orange-hover",
    "hover:proj-23-theme-1-grayish-orange-hover",
    "hover:proj-23-theme-1-desaturated-dark-blue-var-1-hover",
    "hover:proj-23-theme-1-desaturated-dark-blue-var-2-hover",
    "hover:proj-23-theme-1-red-hover",
    "hover:proj-23-theme-1-dark-red-hover",

    "active:proj-23-theme-1-light-grayish-orange-active",
    "active:proj-23-theme-1-grayish-orange-active",
    "active:proj-23-theme-1-desaturated-dark-blue-var-1-active",
    "active:proj-23-theme-1-desaturated-dark-blue-var-2-active",
    "active:proj-23-theme-1-red-active",
    "active:proj-23-theme-1-dark-red-active",
    ...
    "hover:proj-23-theme-2-light-grayish-yellow-hover",
    "hover:proj-23-theme-2-dark-grayish-orange-hover",
    "hover:proj-23-theme-2-dark-moderate-cyan-hover",
    "hover:proj-23-theme-2-very-dark-cyan-hover",
    "hover:proj-23-theme-2-orange-hover",
    "hover:proj-23-theme-2-dark-orange-hover",

    "active:proj-23-theme-2-light-grayish-yellow-active",
    "active:proj-23-theme-2-dark-grayish-orange-active",
    "active:proj-23-theme-2-dark-moderate-cyan-active",
    "active:proj-23-theme-2-very-dark-cyan-active",
    "active:proj-23-theme-2-orange-active",
    "active:proj-23-theme-2-dark-orange-active",
    ...
    "hover:proj-23-theme-3-very-dark-violet-var-3-hover",
    "hover:proj-23-theme-3-dark-magenta-hover",
    "hover:proj-23-theme-3-dark-violet-hover",
    "hover:proj-23-theme-3-vivid-magenta-hover",
    "hover:proj-23-theme-3-pure-cyan-hover",
    "hover:proj-23-theme-3-soft-cyan-hover",

    "active:proj-23-theme-3-very-dark-violet-var-3-active",
    "active:proj-23-theme-3-dark-magenta-active",
    "active:proj-23-theme-3-dark-violet-active",
    "active:proj-23-theme-3-vivid-magenta-active",
    "active:proj-23-theme-3-pure-cyan-active",
    "active:proj-23-theme-3-soft-cyan-active",
  ],
}
